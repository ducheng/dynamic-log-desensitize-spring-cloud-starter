package com.ducheng.dynamic.log.desensitize.utils;
...
public class YmlUtils {
     ...
     * @param content
     */
    public void reloadConfig(String content) {
        patternMap.clear();
        patternMap = getYmlByName(content);
    }
     ...
     * @param context Yml文件名
     * @param key key
     * @return value或者map本身
     */
    public static Object getFromYml(String context, String key){
        // 创建一个Yaml对象
        Yaml yaml = new Yaml(OPTIONS);
        HashMap<String, Object> map = (HashMap<String, Object>)yaml.loadAs(context, HashMap.class);
